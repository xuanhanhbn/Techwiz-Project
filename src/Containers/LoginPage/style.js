...
const styles = StyleSheet.create({
  ...
  boxUserName: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' },
  modal: {
    width: '100%',
    borderRadius: 10,
    padding: 22,
  ...
  boxHrSocial: { display: 'flex', flexDirection: 'row', justifyContent: 'space-between', marginTop: 15, alignItems: 'center' },
  ...
  boxFacebook: { display: 'flex', flexDirection: 'row', alignItems: 'center', backgroundColor: '#3b5998', paddingVertical: 10, borderRadius: 5, justifyContent: 'center' },
  facebookIcon: { fontSize: FontSize.small, color: '#fff', marginRight: 10 },
  facebookText: { color: '#fff', fontSize: FontSize.verySmall },
  boxApple: { display: 'flex', flexDirection: 'row', alignItems: 'center', backgroundColor: '#000', paddingVertical: 10, borderRadius: 5, justifyContent: 'center' },
  appleIcon: { fontSize: FontSize.small, color: '#fff', marginRight: 10 },
  appleText: { color: '#fff', fontSize: FontSize.verySmall },
  boxGoogle: { display: 'flex', flexDirection: 'row', alignItems: 'center', backgroundColor: '#E23436', paddingVertical: 10, borderRadius: 5, justifyContent: 'center' },
